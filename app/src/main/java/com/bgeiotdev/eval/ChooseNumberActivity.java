...
public class ChooseNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Création liste des nombres à choisirs
        initializeSpinner();
    ...
    /**
     * Permet de faire le menu déroulant avec 9 chiffres
     * Quand on le sélectionne il est pré-selectionné
     * Quand on fait rien il fait rien
     */
    ...
    /**
     * Vérification si checkbox est cliqué
     * @param view
     */
    ...
    /**
     * Renvoie dans la grille le nombre choisi
     * et si checkbox activé met couleur différente
     * @param view
     */
    ...
    /**
     * Permet d'enlever un nombre mis sur la grille
     * @param view
     */
